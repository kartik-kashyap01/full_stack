             ...
             <div id="dots"><div id="circle" className='h-2.5 shadow-[2px_2px_0px_0px_#000000] border-2 w-2.5 rounded-[50%]'></div></div>
              ...
              <input onChange={(e) => {
                setEmail(e.target.value)
                     ...
                     className= ' w-full rounded-sm border p-1 ' type="email" value={email} placeholder='enter email' />
                ...
                onChange={(e) => {
                  setPassword(e.target.value)
                    ...
                    <p className='w-full' to='/home' ><button 
                    onClick={handleSubmit}
                    type='submit' className='w-full rounded-sm bg-[#FF6482] active:bg-[#ffffff]    active:shadow-none p-1 mt-8 font-mono  border shadow-[4px_4px_0px_0px_#000000]'
                    >Login</button></p>
